...
const Analytics = () => {
    ...
    const _lecturer = useRouteStore(state => state._lecturer)!
    ...
    const [courseIds, setCourseIds] = useState<string[]>(_lecturer?.course_ids || [])
            ...
            >
                ...
                >
                    ...
                    >
                        {dataLoading.courses ? (
                            ...
                            <InterText
                                ...
                                lineHeight={30}
                            >
                                {(courseIds.filter(id => courses.some(item => item.id === id && item.semester === semester))?.length || 0)}
                            </InterText>
                        )}
                        <Flex>
                            <InterText
                    ...
                    <Flex
                        ...
                        width={(WIDTH - 40 - 16)/2}
                    >
                        {(dataLoading.courses || dataLoading.attendanceSession || dataLoading.schedules) ? (
                            <ActivityIndicator color='black' />
                        ) : (
                            <InterText
                                fontWeight={600}
