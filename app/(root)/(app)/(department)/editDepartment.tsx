...
const EditDepartment = () => {
	...
	const [courseDuration, setCourseDuration] = useState<number | undefined>(parseInt(_course_duration as string) as number)
	...
	const [courseDurationOptions, setCourseDurationOptions] = useState<SelectableDuration[]>([
		{
			...
			value: 5,
			title: '5 years',
			is_selected: _course_duration === '5',
		},
		{
			id: '4',
			value: 4,
			title: '4 years',
			is_selected: _course_duration === '4',
		},
		{
			id: '3',
			value: 3,
			title: '3 years',
			is_selected: _course_duration === '3',
		},
		{
			id: '2',
			value: 2,
			title: '2 years',
			is_selected: _course_duration === '2',
		},
		{
			id: '1',
			value: 1,
			title: '1 years',
			is_selected: _course_duration === '1',
		},
	])
	...
	useEffect(() => {
		...
		const fetchColleges = async () => {
			try {
				...
				if (_college_id) {
					setCollegeName(collegesResponse.data?.find(item => item.id === _college_id)?.college_name!)
				}
	...
	const handleUpdateDepartment = async () => {
		try {
			...
			const departmentResponse = await handleDepartments.update({
				id: _department_id as string,
		...
		>
			...
			<CustomButton
				...
				disabled={!collegeId || !departmentName || !courseDuration || (
					collegeId === _college_id && departmentName === _department_name && courseDuration === parseInt(_course_duration as string)
				)}
			/>
		</FixedWrapper>
		<CustomBottomSheet
